...
class LogParser:
    ...
    def outputResult(self, logClustL):
        ...
        df_log_sorted.drop(columns=['Date', 'Time'], inplace=True)

        df_log_sorted["LineId"] = df_log_sorted.reset_index().index + 1

        df_log_sorted = df_log_sorted[['LineId', 'DateTime', 'TraceId', 'SpanId', 'Service', 'Content', 'EventId', 'EventTemplate', 'ParameterList' , 'Context', 'Thread', 'Level', 'Component']]
        column_names = df_log_sorted.columns
        print(column_names)
